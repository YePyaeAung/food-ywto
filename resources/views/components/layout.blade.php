...
{{-- <!DOCTYPE html>
    ...
    <head>
        ...
        <title>Dolphin Food Delivery</title>
            ...
            <div class="row align-items-center py-3 px-xl-5">
                <div class="col-lg-9 d-none d-lg-block">
                    <a href="" class="text-decoration-none">
                        <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">DP</span>Dolphin</h1>
                    </a>
                </div>
                {{-- Cart Badge --}}
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                        <a href="" class="text-decoration-none d-block d-lg-none">
                            <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">DL</span>Dolphin</h1>
                        </a>
                        <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbarCollapse">
                            <span class="navbar-toggler-icon"></span>
                        </button>
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0 bg-secondary">
                                ...
                                <div class="nav-item dropdown mobile-dropdown">
                                    ...
                                    <div class="dropdown-menu rounded-0 m-0  text-center" style="margin-left:-100px !important;">
                                        ...
                                        <form action="/logout" method="POST">
                                            @csrf
                                            <button type="submit" href="/logout" class="nav-link btn btn-link dropdown-item">Logout</button>
                                        </form>
                                    </div>
                                </div>
                                @else
        ...
        <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
            <div class="row px-xl-5 pt-5">
                <div class="col-lg-6 col-md-12 mb-5 pr-3 pr-xl-5">
                    <a href="" class="text-decoration-none">
                        <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">DP</span>Dolphin</h1>
                    </a>
